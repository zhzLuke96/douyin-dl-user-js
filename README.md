...
- [x] 下载历史
- [x] 自定义文件名
- [x] 作者主页批量下载：内容/封面、断点续传、暂停/继续/结束、后台继续、并发下载、方块进度、排序筛选、失败详情
- [x] 支持配置外部下载器
...
- 260906 1.5.14 文件名特殊字符统一安全处理
- 260825 1.5.13 修复批量下载存储问题
- 260815 1.5.12 修复 bug
- 260814 1.5.11 批量下载支持排序筛选与失败详情
- 260813 1.5.10 修复视频下载失败
- 260812 1.5.9 修复主页状态同步
- 260812 1.5.8 修复配置同步

<details>
<summary>历史版本</summary>

- 260811 1.5.7 修复悬浮窗状态
- 260811 1.5.6 修复视频后缀
- 260809 1.5.5 支持自定义快捷键
- 260809 1.5.4 修复图片后缀
- 260807 1.5.3 修复转码后后缀
- 260807 1.5.2 修复 WebP 转换
- 260806 1.5.1 批量下载支持并发与进度
- 260803 1.5.0 批量下载重构，支持封面/暂停/续传/日志
- 260412 1.4.2 界面优化
- 260411 1.4.1 支持主页批量下载
- 260404 1.3.8 支持切换下载器与分辨率偏好
- 260402 1.3.5 支持外部播放器和下载器
- 260331 1.3.4 新增下载偏好与图片处理
- 260316 1.3.2 修复文件名适配
- 260318 1.3.1 新增配置弹窗、自定义文件名和下载历史
- 260318 1.3.0 UI 重构
- 251224 1.2.8 修复封面下载
- 250929 1.2.7 支持下载弹幕
- 250914 1.2.6 支持截图
- 250827 1.2.4 增强媒体详情
- 250710 1.2.2 修复弹窗样式
- 250710 1.2.0 新增媒体详情与下载控制
- 250602 1.1.1 修复下载按钮
- 250530 1.1.0 代码重构
- 250519 1.0.5 支持 WebP 转 PNG
- 250326 1.0.4 支持下载快捷键
- 250114 1.0.3 优化文件名适配
- 241231 1.0.2 支持含视频图集
...
所有实际保存到本地的文件名都会统一清洗，避免出现下载失败或路径被错误解析：

- Windows 禁字符 `<` `>` `:` `"` `/` `\` `|` `?` `*` 会替换为 `_`
- 控制字符、保留设备名（如 `CON`、`NUL`、`COM1`）会处理，文件名不会以 `.` 或空格结尾
- 单个文件名会限制长度，连续替换产生的 `_` 会自动合并

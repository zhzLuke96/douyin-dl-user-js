...
作者主页右下角会出现“作者主页下载”统一入口，点击后会打开任务面板。

- 点击【开始全量】会自动向下轮询当前作者主页并顺序下载未下载过的作品
- 点击【停止】后会保存进度，下次点击【继续/补漏】会跳过已下载作品
- 点击【重置记录】可以清空当前作者主页的断点状态并重新下载
- 设置里可以控制作者主页右下角入口是否显示
